...
typedef struct zbior_ary {
  long long *mn,*mx; //wskazniki na tablice elementow minimalnych i maksymalnych ciagow arytmetycznych. 
  //Sortuje elementy rosnąco według modulo q, a elementy o tym samym modulo rosnąco według wartości.
...
// Wypisuje wszystkie elementy zbioru w jednej linii oddzielone spacjami
