...
\end{zadanie}
\begin{rozwiazanie}
Załóżmy nie wprost, że nie ma jednego takiego $c$, czyli że są dwa niezerowe wektory $v, w \in V$, takie że $g(v) = c_vf(v)$, $g(w) = c_wf(w)$ i $c_v \neq c_w$. Niech $u = v + w$ i $g(u) = c_uf(u)$. Wtedy
